...
const { outputFiles } = await esbuild.build({ entryPoints: ['src/app/main.js'], bundle: true, format: 'iife', target: 'es2020', minify: false, write: false, loader: { '.txt': 'text' }, legalComments: 'none' });
