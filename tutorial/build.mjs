...
const { outputFiles } = await esbuild.build({ entryPoints: ['tutorial/src/main.js'], bundle: true, format: 'iife', target: 'es2020', minify: false, write: false, legalComments: 'none', loader: { '.json': 'json', '.txt': 'text' } });
