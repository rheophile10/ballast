...
if __name__ == '__main__':
    ...
    rec = next((t for t in sheet['tests'] if t['id'] == rel['test']), None) or sys.exit('release is for a test not on this sheet')
    if rec['hash'] != rel['hash']: sys.exit('release does not compare: test hash differs')
